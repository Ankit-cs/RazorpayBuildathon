...
export const metadata: Metadata = {
  ...
  title: "_projectX — both sides of the agentic counter",
  description:
  ...
  openGraph: {
    ...
    siteName: "_projectX",
    type: "website",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "_projectX — the checkpoint for agentic commerce" }],
  },
  twitter: {
...
const THEME_BOOT = `(function(){try{var t=localStorage.getItem("_projectX-theme");if(t!=="dark")document.documentElement.classList.add("light")}catch(e){}})();`;
